<template>
  <div class="sales-board">
    ...
    <Dialog :is-show="isShowErrDialog" @on-close="hideErrDialog">
      支付失败！
    </Dialog>
    ...
    <div class="site_table">
      <table width="120px" v-for="item in siteType">
    ...
    <div class="table-row-group">
      <ul class="table-row" v-for="item in siteType">
        <li class="table-cell">{{item.name}}</li>
        <li class="table-cell">:</li>
        <li class="table-cell">{{item.count}}</li>
      </ul>
    </div>
...
export default {
    ...
    methods: {
        ...
        onChangeBank(bankOj) {
            this.bankId = bankOj.id;
            console.log(bankOj.id);
        },
